    ...
    <main>
      ...
      <section className="relative bg-[#06081a] noise-overlay py-40 overflow-hidden">
        <div className="relative z-10 mx-auto max-w-[1600px] px-6 lg:px-12 text-center">
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="inline-flex items-center gap-2.5 rounded-lg px-3.5 py-1.5 mb-6" style={{ background: "rgba(27,43,75,0.30)", border: "1px solid rgba(255,255,255,0.10)" }}>
            <span className="font-mono-label text-[10px] tracking-[0.22em] uppercase text-[#C5CDE0]/70">Our Story</span>
          </motion.div>
          <motion.h1
            initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1, duration: 0.7 }}
            className="font-display text-[clamp(32px,5vw,72px)] leading-[1.1] tracking-[-0.02em] text-[#E8E2D9] max-w-4xl mx-auto"
          >
      ...
      <section className="bg-[#FAFAF7] py-24">
        <div className="mx-auto max-w-[1600px] px-6 lg:px-12 grid gap-12 lg:grid-cols-2 items-center">
          <ScrollReveal>
            <h2 className="font-display text-[clamp(28px,3.8vw,56px)] leading-[1.15] tracking-[-0.02em] text-[#0B1029]">Driven by Purpose</h2>
            <p className="font-body mt-6 text-[15px] leading-[1.7] text-[#555] font-light">
      ...
      <section className="grid lg:grid-cols-2">
        <div className="bg-[#06081a] noise-overlay p-12 lg:p-20">
          <div className="relative z-10">
            <div className="inline-flex items-center gap-2.5 rounded-lg px-3.5 py-1.5" style={{ background: "rgba(255,255,255,0.06)", border: "1px solid rgba(255,255,255,0.10)" }}>
              <span className="font-mono-label text-[10px] tracking-[0.22em] uppercase text-[#C5CDE0]/70">Our Mission</span>
            </div>
            <h3 className="font-heading mt-6 text-xl font-semibold text-[#E8E2D9] uppercase tracking-wide">Advance Men's Health</h3>
            <p className="font-body mt-3 text-[15px] leading-[1.7] text-[#E8E2D9]/60 font-light">
            ...
            <h3 className="font-heading mt-10 text-xl font-semibold text-[#E8E2D9] uppercase tracking-wide">Build the Platform</h3>
            <p className="font-body mt-3 text-[15px] leading-[1.7] text-[#E8E2D9]/60 font-light">
        ...
        <div className="bg-[#E8EDF5] p-12 lg:p-20">
          <div className="inline-flex items-center gap-2.5 rounded-lg px-3.5 py-1.5" style={{ background: "rgba(27,43,75,0.10)", border: "1px solid rgba(27,43,75,0.20)" }}>
            <span className="font-mono-label text-[10px] tracking-[0.22em] uppercase text-[#243656]">Our Vision</span>
          </div>
          <h3 className="font-heading mt-6 text-xl font-semibold text-[#0B1029] uppercase tracking-wide">Set the Standard</h3>
          <p className="font-body mt-3 text-[15px] leading-[1.7] text-[#555] font-light">
          ...
          <h3 className="font-heading mt-10 text-xl font-semibold text-[#0B1029] uppercase tracking-wide">Lead What Comes Next</h3>
          <p className="font-body mt-3 text-[15px] leading-[1.7] text-[#555] font-light">
      ...
      <section className="bg-[#FAFAF7] py-24">
        <div className="mx-auto max-w-[1600px] px-6 lg:px-12">
          <ScrollReveal>
            <h2 className="font-display text-[clamp(28px,3.8vw,56px)] leading-[1.15] tracking-[-0.02em] text-[#0B1029]">How We Work</h2>
            <p className="font-body mt-4 text-[15px] leading-[1.7] text-[#555] font-light max-w-2xl">
          ...
          <Accordion type="single" collapsible className="mt-12 max-w-3xl">
            {values.map((v, i) => (
              <AccordionItem key={i} value={`v-${i}`} className="border-b border-dashed border-[#C5CDE0]/70">
                <AccordionTrigger className="font-heading text-lg font-semibold text-[#0B1029]">{v.title}</AccordionTrigger>
                <AccordionContent><p className="font-body text-[15px] leading-[1.7] text-[#555] font-light">{v.desc}</p></AccordionContent>
              </AccordionItem>
            ))}
          </Accordion>
        </div>
      ...
      <section className="bg-[#E8EDF5] py-24">
        <div className="mx-auto max-w-[1600px] px-6 lg:px-12 text-center">
          <ScrollReveal>
            <h2 className="font-display text-[clamp(28px,3.8vw,56px)] leading-[1.15] tracking-[-0.02em] text-[#0B1029]">Our platform is built for scale.</h2>
            <p className="font-body mt-4 text-[15px] leading-[1.7] text-[#555] font-light max-w-2xl mx-auto">
      ...
      <section className="bg-[#FAFAF7] py-24">
        <div className="mx-auto max-w-[1600px] px-6 lg:px-12 grid gap-12 lg:grid-cols-2 items-center">
          <ScrollReveal>
            <div className="inline-flex items-center gap-2.5 rounded-lg px-3.5 py-1.5" style={{ background: "rgba(27,43,75,0.10)", border: "1px solid rgba(27,43,75,0.20)" }}>
              <span className="font-mono-label text-[10px] tracking-[0.22em] uppercase text-[#243656]">Powered By</span>
            </div>
            <h2 className="font-display mt-6 text-[clamp(28px,3.8vw,56px)] leading-[1.15] tracking-[-0.02em] text-[#0B1029] italic">Built on Men's Wellness Centers.</h2>
            <p className="font-body mt-6 text-[15px] leading-[1.7] text-[#555] font-light">
            ...
            <ul className="font-body mt-6 space-y-3 text-[15px] text-[#555] font-light">
      ...
      <section className="bg-[#E8EDF5] py-24">
        <div className="mx-auto max-w-[1600px] px-6 lg:px-12">
          <ScrollReveal>
            <h2 className="font-display text-[clamp(28px,3.8vw,56px)] leading-[1.15] tracking-[-0.02em] text-[#0B1029]">United by a Shared Goal</h2>
            <p className="font-body mt-4 text-[15px] leading-[1.7] text-[#555] font-light max-w-2xl">
          ...
          <Tabs defaultValue="leadership" className="mt-12">
            <TabsList className="bg-transparent border-0 p-0 h-auto flex flex-wrap gap-2 mb-8">
              {teamTabs.map((t) => (
                <TabsTrigger key={t.id} value={t.id} className="font-mono-label text-[10px] tracking-[0.1em] uppercase px-4 py-2.5 rounded-md data-[state=active]:bg-white/70 data-[state=active]:backdrop-blur-[10px] data-[state=active]:border data-[state=active]:border-[rgba(27,43,75,0.25)] data-[state=inactive]:bg-white/30 data-[state=inactive]:border data-[state=inactive]:border-[rgba(27,43,75,0.15)]">{t.label}</TabsTrigger>
              ))}
            </TabsList>
            {teamTabs.map((t) => (
                ...
                <div className="mt-8 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                  {t.members.map((m) => (
                    <motion.div key={m.name} initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="rounded-2xl border border-gray-100 bg-white p-6 shadow-sm">
                      ...
                      <h3 className="font-heading text-lg font-semibold text-[#0B1029]">{m.name}</h3>
                      <p className="font-mono-label text-[10px] tracking-[0.14em] uppercase text-[#243656] mt-1">{m.title}</p>
                      <p className="font-body mt-3 text-[13px] text-[#555] font-light">{m.bio}</p>
                    </motion.div>
                  ))}
                </div>
              </TabsContent>
